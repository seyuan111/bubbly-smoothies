        ...
        {isOpen ? (
            <form onSubmit={handleSearch} className="relative flex items-center justify-center w-full">
                <div className="relative w-1/2">
                    <input type="text" placeholder="search" onChange={(e) => setSearch(e.target.value)} value={search} className="bg-gray-200 px-4 py-2 pl-2 pr-10 rounded focus:outline-none w-full placeholder:text-gray-700"></input>
